    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <form action="<?php echo e(route('editCategories')); ?>" method="POST" enctype="multipart/form-data">
                ...
                <input hidden value="<?php echo e($thisCategory); ?>" type="text" id="idCategory" class="form-control"
                    name="idCategory" required autofocus>
                    
                <input hidden value="<?php echo e($idProduct); ?>" type="text" id="idProduct" class="form-control"
