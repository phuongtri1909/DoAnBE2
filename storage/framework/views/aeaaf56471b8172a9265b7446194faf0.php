                                        ...
                                        <div class="section-nav">
                                            <ul class="section-tab-nav tab-nav">
                                                <li class="active btn"><a data-toggle="tab"
                                                        href="#tab1"><?php echo e($manufacturer->manufacturerName); ?></a></li>
                                            </ul>
                                        </div>
                                            ...
                                            <div class="product">
                                                ...
                                                <div class="product-body">
                                                    ...
                                                    <h3 class="product-name">
                                                        ...
                                                        <a class="button" href="<?php echo e(route('detailProduct', $productName = Str::slug($item->productName, '-'))); ?>"> <?php echo e($item->productName); ?></a>
