            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <span class="copyright">
                        ...
                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Created by  <i class="fa fa-heart-o" aria-hidden="true"></i> <a href="{{ route('home') }}" target="_blank">3TDLStore</a>
